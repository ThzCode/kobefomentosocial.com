  ...
  features: [
    {
      ...
      description:
        'Your supercharged AI call assistant that gives you unprecedented leverage on each call',
    },
    {
      id: 2,
      ...
      description:
        'Use the secret sauce of your winning calls and avoid deal threatening mistakes by using machine learning to take you to the finish line',
    },
    {
      id: 3,
      icon: 'flaticon-ruler',
      title: 'Make Every Rep A Superstar Performer',
      description:
        'Source, contact, pipeline candidates from Linkedin with Sourced’s chrome extension that streamlines Linkedin recruiting',
    },
    {
      id: 4,
      icon: 'flaticon-startup',
      title: 'Clone the performance of your top reps and boost wins across the entire time ',
      description:
        'Clone the performance of your top reps and boost wins across the entire time',
    },
    {
      id: 5,
      ...
      description:
        'Start making data driven decisions by understanding which subject lines, senders, time of day, and templates are getting the best responses on email and linkedin. Sourced can even track how many times an email has been opened and alert you in real time',
    },
    {
      id: 6,
      icon: 'flaticon-creative',
      title: 'Nurture Candidate Relationships',
      description:
        'Candidate experience is everything. Improve your candidate experience with a centralized database where you can search candidates, re-engaged past candidates, and keep conversations in one place',
    },
  ],
  qualityFeature: [
    {
