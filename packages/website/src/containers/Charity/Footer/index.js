    ...
    <FooterWrapper>
      <Container width="1260px">
        ...
        <Box className="row copyright" {...row}>
          <CopyrightText>
            <Text className="text" content="© 2020 Kobe Fomento Social" />
          </CopyrightText>
          <SocialList>
            ...
            <li className="facebook">
              <a
                ...
                href="https://www.facebook.com/kobefomentosocial/"
                aria-label="facebook kobefomentosocial"
              >
                <Icon icon={facebook} />
              </a>
            </li>
            ...
            <li className="instagram">
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.instagram.com/kobefomentosocial/"
                aria-label="instagram kobefomentosocial"
              >
                <Icon icon={instagram} />
              </a>
            </li>
            <li className="youtube">
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.youtube.com/kobefomentosocial/"
                aria-label="youtube kobefomentosocial"
              >
                <Icon icon={youtube} />
              </a>
            </li>
            <li className="twitter">
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://twitter.com/kobefomentosocial"
                aria-label="twitter kobefomentosocial"
              >
                <Icon icon={twitter} />
              </a>
            </li>
